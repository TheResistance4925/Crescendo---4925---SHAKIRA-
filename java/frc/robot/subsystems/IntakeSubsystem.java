...
public class IntakeSubsystem extends SubsystemBase {
   ...
   public void runIntake(double sequenceDelay, double intakeSpeed, double shooterSpeed, double runTime) {
...
(double sequenceDelay, double primeIntakeSpeed, double primeShooterSpeed, double primeTime, 
