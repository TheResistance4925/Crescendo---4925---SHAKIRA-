...
public class ShoulderSubsystem extends SubsystemBase {
  ...
  public ShoulderSubsystem() {
   ...
   // m_motor.setSoftLimit(SoftLimitDirection.kForward, (float) Constants.Arm.kSoftLimitForward);
    ...
    m_setpoint = Constants.Arm.kShoulderHomePosition;
    ...
    m_follower = new CANSparkMax(25, MotorType.kBrushless );
   ...
   */
  public void setShoulderTargetPosition(double _setpoint) {
  ...
  public void periodic() { // This method will be called once per scheduler run
    ...
    SmartDashboard.putNumber("Shoulder Encoder", m_encoder.getPosition());
